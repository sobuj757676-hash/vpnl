    ...
    >
      <div className="flex flex-col min-h-screen font-sans bg-background text-foreground">
        ...
        <main className="flex-1 container px-4 mx-auto max-w-[800px] py-16 md:py-24">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-gray-900 dark:text-white">Terms & Conditions</h1>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: legalContent.termsHtml || 'No content provided.' }}
          />
        </main>
